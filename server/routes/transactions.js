...
router.get('/', transactionController.getTransaction, transactionController.getTotal, transactionController.getBudgets, (req, res) => {
...
router.put('/', transactionController.editBudgets, transactionController.getBudgets, (req, res) => {
    return res.status(200).json({...res.locals});
});
